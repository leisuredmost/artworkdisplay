...
if($action == 'save_rating_comment'){
	$save = $crud->save_rating_comment();
	if($save)
		echo $save;
}
if($action == 'delete_rating_comment'){
	$save = $crud->delete_rating_comment();
	if($save)
		echo $save;
}
if($action == 'save_user'){
...
if($action == "delete_art2"){
	$save = $crud->delete_art2();
	if($save)
		echo $save;
}
