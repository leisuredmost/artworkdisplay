    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-6">
                ...
                <p>Customer Address: <b><?php echo $urow[$customer_id]['address'] ?></b></p>
                <p>Customer Contact #: <b><?php echo $urow[$customer_id]['contact'] ?></b></p>
            </div>
            <div class="col-lg-6">
...
<script>
    ...
    $('#manage-order').submit(function(e){
        ...
        start_load()
        $.ajax({
            url:'admin/ajax.php?action=update_order',
            method:"POST",
            data:$(this).serialize(),
