			...
			<div class="card-body">
				<form action="" id="manage-art">
					...
					<div class="row form-group">
						<input type="file" id="chooseFile" multiple="multiple" onchange="displayIMG(this)" accept="image/x-png,image/jpeg,image/jpg" style="display: none" required="">
					...
					<div class="form-group">
							<div class="form-check">
							  <input type="hidden" name="status" value="0" id="status" required="">
