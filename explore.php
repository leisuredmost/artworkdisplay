    ...
    direction: rtl ;
        ...
        <section id="list">
            <div class="container-fluid mt-3 pt-2">
                <h4 class="text-center">Explore Portfolios</h4>
                <hr class="divider">
                <div class="row-items">
                <div class="col-lg-12">
                <?php
                            ...
                            <div class="col-md-8">
                                ...
                                <?php if(isset($fs_aid[$row['id']])): ?>
                                    <div <?php echo !empty($rtl) ? "style='direction:ltr'" : '' ?>>
                                        ...
                                        <span class="badge badge-primary"><a href="javascript:void(0)" class="review_this text-white" data-attr="<?php echo $fs_aid[$row['id']]['id'] ?>">Review</a></span>
